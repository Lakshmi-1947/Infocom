...
function NRV2XSL_LinkLevelSimulator(speed, InputDopplerShift,MCSIndex,SCS,DMRS,InputChannelModel,NumSubchannels, SNR_NA)
close all
...
%             dmrsLayerSymbols = PSSCH_DMRSsymbols;     
    ...
    % Append row to CSV
    fid = fopen(csvFilePath, 'a');  % Append mode
    fprintf(fid, '%d,%d,%d,%d,%d\n', speed, DMRS, NumSubchannels, MCSIndex, TBS);
    fclose(fid);
