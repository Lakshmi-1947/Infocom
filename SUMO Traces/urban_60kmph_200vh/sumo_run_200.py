...
sumoCmd = ["sumo", "-c", "C:/Users/Vaideeswaran/Downloads/tr_103766v010101p0/urban_60kmph_200vh/sumo.cfg"]
traci.start(sumoCmd)
...
print("here")
dataset.to_excel("C:/Users/Vaideeswaran/Downloads/tr_103766v010101p0/urban_60kmph_200vh/output.xlsx", index=False)
time.sleep(5)